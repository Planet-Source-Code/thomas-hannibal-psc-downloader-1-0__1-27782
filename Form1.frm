VERSION 5.00
Object = "{DD9096C7-70E9-4BDE-8DFA-0B9A5AEB19C0}#1.0#0"; "GradientButtonS_c.ocx"
Begin VB.Form Form1 
   BackColor       =   &H80000001&
   BorderStyle     =   0  'None
   ...
   Begin VB.TextBox Text2 
      ...
      Width           =   1950
   End
   Begin KDCButton105c.KDCButton_c cmd 
      Height          =   285
      Index           =   0
      Left            =   0
      TabIndex        =   3
...
Private Sub Image1_OLEDragDrop(Data As DataObject, Effect As Long, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    Dim s As String
    If dPath = "" Then MsgBox "No destination path available..."
...
Private Sub Image2_OLEDragDrop(Data As DataObject, Effect As Long, Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If Data.GetFormat(vbCFText) Then
        ...
        Set Image2.Picture = imgClosed.Picture
        r = FileSave(Text1.Text, dPath & "\" & fName & "_about.txt")
